...
if __name__ == '__main__':
    ...
    my_car = Car_Dynamics(start[0], start[1], 0, np.deg2rad(args.psi_start), length=1.8, dt=0.4)
    MPC_HORIZON = 5  # MPC区间
    ...
    print(path_v.shape)
    env.draw_path(path_v)                   # 画垂直泊车路径 (,2)
    ...
    for i, point in enumerate(path_v):
        ...
        #     print("v == 0")
        # elif my_car.v > 0:
        #     pwm_forward.Motor_Forward(15)
        #     print("v > 0")
        # else:
        #     pwm_forward.Motor_back(15)
        #     print("v < 0")
